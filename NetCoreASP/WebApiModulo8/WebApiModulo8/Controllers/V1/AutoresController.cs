...
namespace WebApiModulo8.Controllers.V1
{
    ...
    public class AutoresController : ControllerBase
    {
        ...
        //usando paginacion para retornar informacion, esto hace que se cargue mas rapido en el cliente
        ...
        public async Task<ActionResult<IEnumerable<AutorDTO>>> Get(int numeroDePagina = 1, int cantidadDeRegistros = 10)
        {
            ...
            //se usa Skip y Take para paginar Take dice la cantidad de registros a tomar de la BD
