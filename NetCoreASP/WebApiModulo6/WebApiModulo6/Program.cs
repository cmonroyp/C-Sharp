    ...
    public class Program
    {
        ...
        public static IWebHostBuilder CreateWebHostBuilder(string[] args) =>
            ...
            .ConfigureAppConfiguration((env, config) =>
            {
                ...
                config.AddJsonFile($"appsettings.{ambiente}.json", optional: true, reloadOnChange: true);//orden de lectura de la configuracion, toma precedencia del ultimo creado
